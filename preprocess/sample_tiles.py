...
parser.add_argument("--n", help="number of tiles to sample", type=int, default=2048)
...
# Function to process and save each tile
def process_and_save_tile(tile, i):
    ...
    safe_print(f"Saved tile {i} to {out_file}")


# Use ThreadPoolExecutor to parallelize the tile processing and saving
with concurrent.futures.ThreadPoolExecutor() as executor:
    futures = [
        executor.submit(process_and_save_tile, tile, i)
